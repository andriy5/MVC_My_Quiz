 ...
 */
final class Version20200502101503 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE blabla id_categorie INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE id_categorie blabla INT DEFAULT NULL');
    }
}
